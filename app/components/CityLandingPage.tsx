        ...
        >
            ...
            <main className="mx-auto max-w-4xl px-4 sm:px-6 md:px-8">
                                ...
                                >
                                    <div className="mb-6 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs font-semibold text-slate-300">Saldo {cityName}</span>
                                        </div>
                ...
                <section aria-labelledby="keunggulan-heading" className="mb-10 sm:mb-14">
                    <h2 id="keunggulan-heading" className="mb-2 text-xl font-black text-white sm:text-2xl">Kenapa Paylaterku {cityName}?</h2>
